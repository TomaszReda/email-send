package pl.tomekreda.library.email.send;
...
import org.springframework.boot.autoconfigure.SpringBootApplication;
import org.springframework.context.annotation.Bean;
import pl.tomekreda.library.email.send.config.listener.EmailListener;
...
public class EmailSendApplication {
    ...
    @Bean
    MessageListenerAdapter listenerAdapter(EmailListener receiver) {
